...
class APITestCase(unittest.TestCase):
    ...
    def test_bad_auth(self):
        ...
        u = User(email='xcharming@qq.com', password='123', confirmed=True,
                 role=r)
        db.session.add(u)
        db.session.commit()
        ...
        response = self.client.get(
            ...
            headers=self.get_api_headers('xcharming@qq.com', 'dog'))
    ...
    def test_token_auth(self):
        ...
        response = self.client.get(
            ...
            headers=self.get_api_headers('xcharming@qq.com', '123'))
        self.assertTrue(response.status_code == 200)
        json_response = json.loads(response.data.decode('utf-8'))
    ...
    def test_unconfirmed_account(self):
        ...
        r = Role.query.filter_by(name='User').first()
        self.assertIsNotNone(r)
        u = User(email='xcharming@qq.com', password='123', confirmed=False,
                 role=r)
        db.session.add(u)
        db.session.commit()
    ...
    def test_users(self):
        ...
        r = Role.query.filter_by(name='User').first()
        self.assertIsNotNone(r)
        u1 = User(email='xcharming@qq.com', username='john',
                  password='123', confirmed=True, role=r)
