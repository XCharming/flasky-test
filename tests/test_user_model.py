...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_valid_email_change_token(self):
        u = User(email='xcharming@foxmail.com', password='123')
        db.session.add(u)
        db.session.commit()
        token = u.generate_email_change_token('kddgsbsd@outlook.com')
        self.assertTrue(u.change_email(token))
        self.assertTrue(u.email == 'kddgsbsd@outlook.com')
        
    def test_invalid_email_change_token(self):
        u1 = User(email='xcharming@foxmail.com', password='123')
        u2 = User(email='kddgsbsd@outlook.com', password='456')
        db.session.add(u1)
        db.session.add(u2)
        db.session.commit()
        token = u1.generate_email_change_token('kddgsbsd@gmail.com')
        self.assertFalse(u2.change_email(token))
        self.assertTrue(u2.email == 'kddgsbsd@outlook.com')
    ...
    def test_duplicate_email_change_token(self):
        ...
        db.session.add(u2)
        db.session.commit()
        token = u2.generate_email_change_token('xcharming@foxmail.com')
        self.assertFalse(u2.change_email(token))
        self.assertTrue(u2.email == 'kddgsbsd@outlook.com')
